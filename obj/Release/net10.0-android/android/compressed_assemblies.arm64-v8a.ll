...
@compressed_assembly_descriptors = dso_local local_unnamed_addr global [143 x %struct.CompressedAssemblyDescriptor] [
	...
	%struct.CompressedAssemblyDescriptor {
		...
		i1 false, ; bool loaded
		i32 13503880; uint32_t buffer_offset
	}, ; 140: Java.Interop
	%struct.CompressedAssemblyDescriptor {
		i32 22560, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 13674888; uint32_t buffer_offset
	}, ; 141: Mono.Android.Runtime
	%struct.CompressedAssemblyDescriptor {
		i32 2152448, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 13697448; uint32_t buffer_offset
	} ; 142: Mono.Android
], align 4

@uncompressed_assemblies_data_size = dso_local local_unnamed_addr constant i32 15849896, align 4

@uncompressed_assemblies_data_buffer = dso_local local_unnamed_addr global [15849896 x i8] zeroinitializer, align 1
